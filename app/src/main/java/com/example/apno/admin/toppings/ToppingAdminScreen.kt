    ...
    Scaffold(
        floatingActionButton = {
            FloatingActionButton(onClick = {
                ...
                Icon(Icons.Default.Add, contentDescription = stringResource(R.string.add_topping))
            }
        }
    ) { padding ->
                    ...
                    trailingContent = {
                        Row {
                            IconButton(onClick = {
                                ...
                                Icon(Icons.Default.Edit, contentDescription = stringResource(R.string.edit_topping))
                            }
...
fun ToppingEditDialog(
    ...
    AlertDialog(
        ...
        title = { Text(if (topping == null) stringResource(R.string.add_topping) else stringResource(R.string.edit_topping)) },
        text = {
            Column {
                OutlinedTextField(
                    value = name,
                    onValueChange = { name = it },
                    label = { Text(stringResource(R.string.topping_name)) }
                )
                OutlinedTextField(
                    value = price,
